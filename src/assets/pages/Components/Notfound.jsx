  ...
  return (
    <div className='h-screen w-full grid place-items-center relative  '>
        ...
        <div className="absolute top-0 left-0 z-[1] w-full h-screen flex flex-col lg:justify-center items-center mt-[80px] ">
          ...
          <h3 className='font-aldrich text-primarytxt font-medium text-[18px] text-center  '>Your location is out of our planet and you are alone here. Please , come back to <Link to="/" className='text-brand'>our planet</Link>.</h3>
          <Link to="/" className='px-10 py-2 bg-brand text-primarytxt font-semibold rounded-md lg:mt-2 mt-[200px] '>Go Back</Link>
        </div>
    </div>
  )
}
