  ...
  return (
    <div className="flex flex-col gap-y-5 hover:bg-clrthird/10 p-2 rounded-md">
      <div className="flex gap-x-5 items-center">
        <img src={props.profile} alt="profile" className=" object-cover w-[60px] h-[60px] rounded-full" />
        <div className="w-full">
          ...
          <div className="flex gap-x-5 mt-1">
            <button type="button" className="py-2 px-7 bg-brand text-primarytxt font-bold rounded-md font-ubuntu ">Confirm</button>
            <button type="button" className="py-2 px-7 bg-clrthird/20 text-bodybg font-bold rounded-md font-ubuntu  ">Delete</button>
          </div>
        </div>
      </div>
    </div>
